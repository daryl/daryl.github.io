...
},{"pBGvAp":291}],291:[function(require,module,exports){
...
window.onload = function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              obj = { name: name, email: email, msg: msg };
              _context.next = 6;
              return fetch('/hey', {
  ...
  var patt = /contact(\.html)?$/;
  var path = location.pathname;

  if (!patt.test(path)) return;

  var form = λ('form');
  var butt = λ('button', form);
  var node = λ('input', form);

  // Placeholders
  var holders = ['Okay. Next, your email?', 'And your message...'];
...
function λ() {
  ...
  switch (args.length) {
    case 2:
      'number' == typeof args[1] ? all = args[1] : ctx = args[1];
      break;
    case 3:
      ctx = args[1];
      all = args[2];
...
},{"babel-polyfill":1,"whatwg-fetch":292}]},{},[293])